...
exports.getArticleById = function (id, callback) {
  ...
  Article.findOne({_id: mongoose.Types.ObjectId(id)}, callback)
    .populate({
...
exports.editExistingArticle = function (
  article_id,
  pending_article,
  is_moderator,
  callback
  ...
  Article.findById(article_id, function (err, article) {
    if (err) {
      ...
      try {
        ...
        article.rejected_articles = article.rejected_articles.concat(
          article.pending_articles
        );
      ...
      let pending_articles = article.pending_articles.forEach(
        mongoose.Types.ObjectId
      );
      Article.findByIdAndUpdate(
        article_id,
        {pending_articles: pending_articles, is_pending: true},
        callback
      );
    }
  });
...
exports.findArticleByPendingArticleId = function (pending_id, callback) {
  ...
  Article.find(
    {pending_article: mongoose.Types.ObjectId(pending_id)},
    callback
  );
};
...
exports.unlikeArticle = async (article_id, user_id, callback) => {
